...
import { addProductValidation, editProductValidation } from './middleware/productValidation.js';
import { validationResult } from 'express-validator';

//import { id_Validation, field_Validation } from './middleware/validation.js';
...
app.post("/dashboard", async (req, res) => {
  try {
    ...
    const total = await productData.getDashboardCount({filterCategory, search});


    const rows = await productData.getDashboard({filterCategory, search, size: limit, offset});
